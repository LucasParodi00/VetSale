...
//             const { codProducto } = location.path[0] === '*' ? req.body.detalleVenta[location.path[1]] : req.body;
//             const existingProduct = await Producto.findByPk(codProducto);
//             if (value > existingProduct.stock) {
//                 throw new Error(`No puedes vender más productos de los que tienes en stock. Stock actual: ${existingProduct.stock}`);
//             }
//         }
//         return true;
//     }),
